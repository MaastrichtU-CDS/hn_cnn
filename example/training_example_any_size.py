...
DATA = {
    TRAIN: {
        CLINICAL_DATA_PATH: "./CT_NIFTI/canada.csv",
        SCANS_PATH: "./CT_NIFTI/scans",
        MASKS_PATH: "./CT_NIFTI/masks",
        MASK_SUFFIX: "_mask",
    },
    VALIDATION: {
        CLINICAL_DATA_PATH: "./CT_NIFTI/canada.csv",
    ...
    TESTING: {
        CLINICAL_DATA_PATH: "./CT_NIFTI/maastro.csv",
        SCANS_PATH: "./CT_NIFTI/scans",
        MASKS_PATH: "./CT_NIFTI/masks",
        MASK_SUFFIX: "_mask",
    }
        ...
        with contextlib.redirect_stdout(o):
            ...
            for dataset in [TRAIN, TRAIN_METRICS, VALIDATION, TESTING]:
                ...
                dataset_parsed = ImageDataset(
                    ...
                    event=CONFIGURATIONS[EVENT],
                    preprocess=True,
                    mask_path=paths[MASKS_PATH],
                    mask_suffix=paths[MASK_SUFFIX],
                )
